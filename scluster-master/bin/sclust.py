...
if __name__ == "__main__":
    ...
    labels = assn_to_p(best_assignment)                            # [Davide Vandelli / fluve] added this line to save the assignment.
    
    print("Determined number of clusters to be {}".format(chosen_groups))
    print("Quality scores = {}".format(quality_scores))
    print("Assignment = {}".format(labels))

    pd.Series(labels).to_csv('scluster_labels.csv', index=False)   # [Davide Vandelli / fluve] added this line to save the assignment.
